...
For interactive requirements gathering, use the **Requirements Gathering** agent or `/requirements-start` prompt. For deployment strategy, use the **Deployment Strategy** agent or `/deployment-start` prompt. Section 1 and Section 2 can be run in either order.
